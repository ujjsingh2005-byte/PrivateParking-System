...
import { Settings, Shield, Bell, Moon, Globe, ChevronRight, LayoutGrid, Layers, ShieldAlert } from 'lucide-react';
    ...
    return (
      <div className="max-w-md mx-auto mt-24 bg-red-500/10 p-8 rounded-3xl border border-red-500/20 text-center space-y-4 shadow-2xl">
        ...
        <p className="text-red-300 text-sm leading-relaxed">
          Settings management requires Administrator Authority. Standard users can browse parking zones, select slots, and execute payments on the Public Zones page.
        </p>
